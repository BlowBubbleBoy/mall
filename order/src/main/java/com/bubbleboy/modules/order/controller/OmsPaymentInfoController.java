...
import com.bubbleboy.modules.order.excel.OmsPaymentInfoExcel;
...
//    @RequiresPermissions("order:omspaymentinfo:page")
    public Result<PageData<OmsPaymentInfoDTO>> page(@Parameter(hidden = true) @RequestParam Map<String, Object> params){
        PageData<OmsPaymentInfoDTO> page = omsPaymentInfoService.page(params);

        return new Result<PageData<OmsPaymentInfoDTO>>().ok(page);
    }

    @GetMapping("{id}")
    @Operation(summary = "信息")
//    @RequiresPermissions("order:omspaymentinfo:info")
    public Result<OmsPaymentInfoDTO> get(@PathVariable("id") Long id){
        OmsPaymentInfoDTO data = omsPaymentInfoService.get(id);

        return new Result<OmsPaymentInfoDTO>().ok(data);
    }
...
//    @RequiresPermissions("order:omspaymentinfo:save")
    public Result save(@RequestBody OmsPaymentInfoDTO dto){
        //效验数据
        ValidatorUtils.validateEntity(dto, AddGroup.class, DefaultGroup.class);

        omsPaymentInfoService.save(dto);
...
//    @RequiresPermissions("order:omspaymentinfo:update")
    public Result update(@RequestBody OmsPaymentInfoDTO dto){
        //效验数据
        ValidatorUtils.validateEntity(dto, UpdateGroup.class, DefaultGroup.class);

        omsPaymentInfoService.update(dto);
...
//    @RequiresPermissions("order:omspaymentinfo:delete")
    public Result delete(@RequestBody Long[] ids){
        ...
        omsPaymentInfoService.delete(ids);
    ...
    @LogOperation("导出")
//   @RequiresPermissions("order:omspaymentinfo:export")
    public void export(@Parameter(hidden = true) @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<OmsPaymentInfoDTO> list = omsPaymentInfoService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "支付信息表", list, OmsPaymentInfoExcel.class);
    }
