...
import com.bubbleboy.modules.order.excel.OmsOrderSettingExcel;
...
//    @RequiresPermissions("order:omsordersetting:page")
    public Result<PageData<OmsOrderSettingDTO>> page(@Parameter(hidden = true) @RequestParam Map<String, Object> params){
        PageData<OmsOrderSettingDTO> page = omsOrderSettingService.page(params);

        return new Result<PageData<OmsOrderSettingDTO>>().ok(page);
    }

    @GetMapping("{id}")
    @Operation(summary = "信息")
//    @RequiresPermissions("order:omsordersetting:info")
    public Result<OmsOrderSettingDTO> get(@PathVariable("id") Long id){
        OmsOrderSettingDTO data = omsOrderSettingService.get(id);

        return new Result<OmsOrderSettingDTO>().ok(data);
    }
...
//    @RequiresPermissions("order:omsordersetting:save")
    public Result save(@RequestBody OmsOrderSettingDTO dto){
        //效验数据
        ValidatorUtils.validateEntity(dto, AddGroup.class, DefaultGroup.class);

        omsOrderSettingService.save(dto);
...
//    @RequiresPermissions("order:omsordersetting:update")
    public Result update(@RequestBody OmsOrderSettingDTO dto){
        //效验数据
        ValidatorUtils.validateEntity(dto, UpdateGroup.class, DefaultGroup.class);

        omsOrderSettingService.update(dto);
...
//    @RequiresPermissions("order:omsordersetting:delete")
    public Result delete(@RequestBody Long[] ids){
        ...
        omsOrderSettingService.delete(ids);
    ...
    @LogOperation("导出")
//   @RequiresPermissions("order:omsordersetting:export")
    public void export(@Parameter(hidden = true) @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<OmsOrderSettingDTO> list = omsOrderSettingService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "订单配置信息", list, OmsOrderSettingExcel.class);
    }
