...
import com.bubbleboy.modules.order.excel.OmsOrderReturnReasonExcel;
...
//    @RequiresPermissions("order:omsorderreturnreason:page")
    public Result<PageData<OmsOrderReturnReasonDTO>> page(@Parameter(hidden = true) @RequestParam Map<String, Object> params){
        PageData<OmsOrderReturnReasonDTO> page = omsOrderReturnReasonService.page(params);

        return new Result<PageData<OmsOrderReturnReasonDTO>>().ok(page);
    }

    @GetMapping("{id}")
    @Operation(summary = "信息")
//    @RequiresPermissions("order:omsorderreturnreason:info")
    public Result<OmsOrderReturnReasonDTO> get(@PathVariable("id") Long id){
        OmsOrderReturnReasonDTO data = omsOrderReturnReasonService.get(id);

        return new Result<OmsOrderReturnReasonDTO>().ok(data);
    }
...
//    @RequiresPermissions("order:omsorderreturnreason:save")
    public Result save(@RequestBody OmsOrderReturnReasonDTO dto){
        //效验数据
        ValidatorUtils.validateEntity(dto, AddGroup.class, DefaultGroup.class);

        omsOrderReturnReasonService.save(dto);
...
//    @RequiresPermissions("order:omsorderreturnreason:update")
    public Result update(@RequestBody OmsOrderReturnReasonDTO dto){
        //效验数据
        ValidatorUtils.validateEntity(dto, UpdateGroup.class, DefaultGroup.class);

        omsOrderReturnReasonService.update(dto);
...
//    @RequiresPermissions("order:omsorderreturnreason:delete")
    ...
    @LogOperation("导出")
//   @RequiresPermissions("order:omsorderreturnreason:export")
    public void export(@Parameter(hidden = true) @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<OmsOrderReturnReasonDTO> list = omsOrderReturnReasonService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "退货原因", list, OmsOrderReturnReasonExcel.class);
    }
