...
import com.bubbleboy.modules.coupon.excel.SmsCouponSpuCategoryRelationExcel;
...
//    @RequiresPermissions("coupon:smscouponspucategoryrelation:page")
    public Result<PageData<SmsCouponSpuCategoryRelationDTO>> page(@Parameter(hidden = true) @RequestParam Map<String, Object> params){
...
//    @RequiresPermissions("coupon:smscouponspucategoryrelation:delete")
    ...
    @LogOperation("导出")
//   @RequiresPermissions("coupon:smscouponspucategoryrelation:export")
    public void export(@Parameter(hidden = true) @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<SmsCouponSpuCategoryRelationDTO> list = smsCouponSpuCategoryRelationService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "优惠券分类关联", list, SmsCouponSpuCategoryRelationExcel.class);
    }
