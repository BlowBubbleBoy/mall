...
import com.bubbleboy.modules.coupon.excel.SmsCouponHistoryExcel;
...
//    @RequiresPermissions("coupon:smscouponhistory:page")
    public Result<PageData<SmsCouponHistoryDTO>> page(@Parameter(hidden = true) @RequestParam Map<String, Object> params){
...
//    @RequiresPermissions("coupon:smscouponhistory:delete")
    ...
    @LogOperation("导出")
//   @RequiresPermissions("coupon:smscouponhistory:export")
    public void export(@Parameter(hidden = true) @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<SmsCouponHistoryDTO> list = smsCouponHistoryService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "优惠券领取历史记录", list, SmsCouponHistoryExcel.class);
    }
