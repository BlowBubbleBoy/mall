...
import com.bubbleboy.modules.coupon.excel.SmsSeckillSkuRelationExcel;
...
//    @RequiresPermissions("coupon:smsseckillskurelation:page")
    public Result<PageData<SmsSeckillSkuRelationDTO>> page(@Parameter(hidden = true) @RequestParam Map<String, Object> params){
...
//    @RequiresPermissions("coupon:smsseckillskurelation:delete")
    ...
    @LogOperation("导出")
//   @RequiresPermissions("coupon:smsseckillskurelation:export")
    public void export(@Parameter(hidden = true) @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<SmsSeckillSkuRelationDTO> list = smsSeckillSkuRelationService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "秒杀活动商品关联", list, SmsSeckillSkuRelationExcel.class);
    }
