...
import com.bubbleboy.modules.coupon.excel.SmsMemberPriceExcel;
...
//    @RequiresPermissions("coupon:smsmemberprice:page")
    public Result<PageData<SmsMemberPriceDTO>> page(@Parameter(hidden = true) @RequestParam Map<String, Object> params){
...
//    @RequiresPermissions("coupon:smsmemberprice:delete")
    ...
    @LogOperation("导出")
//   @RequiresPermissions("coupon:smsmemberprice:export")
    public void export(@Parameter(hidden = true) @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<SmsMemberPriceDTO> list = smsMemberPriceService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "商品会员价格", list, SmsMemberPriceExcel.class);
    }
