...
import com.bubbleboy.modules.coupon.excel.SmsSeckillSessionExcel;
...
//    @RequiresPermissions("coupon:smsseckillsession:page")
    public Result<PageData<SmsSeckillSessionDTO>> page(@Parameter(hidden = true) @RequestParam Map<String, Object> params){
...
//    @RequiresPermissions("coupon:smsseckillsession:delete")
    ...
    @LogOperation("导出")
//   @RequiresPermissions("coupon:smsseckillsession:export")
    public void export(@Parameter(hidden = true) @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<SmsSeckillSessionDTO> list = smsSeckillSessionService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "秒杀活动场次", list, SmsSeckillSessionExcel.class);
    }
