...
import com.bubbleboy.modules.coupon.excel.SmsSeckillSkuNoticeExcel;
...
//    @RequiresPermissions("coupon:smsseckillskunotice:page")
    public Result<PageData<SmsSeckillSkuNoticeDTO>> page(@Parameter(hidden = true) @RequestParam Map<String, Object> params){
        PageData<SmsSeckillSkuNoticeDTO> page = smsSeckillSkuNoticeService.page(params);

        return new Result<PageData<SmsSeckillSkuNoticeDTO>>().ok(page);
    }

    @GetMapping("{id}")
    @Operation(summary = "信息")
//    @RequiresPermissions("coupon:smsseckillskunotice:info")
    public Result<SmsSeckillSkuNoticeDTO> get(@PathVariable("id") Long id){
        SmsSeckillSkuNoticeDTO data = smsSeckillSkuNoticeService.get(id);

        return new Result<SmsSeckillSkuNoticeDTO>().ok(data);
    }
...
//    @RequiresPermissions("coupon:smsseckillskunotice:save")
    public Result save(@RequestBody SmsSeckillSkuNoticeDTO dto){
        //效验数据
        ValidatorUtils.validateEntity(dto, AddGroup.class, DefaultGroup.class);

        smsSeckillSkuNoticeService.save(dto);
...
//    @RequiresPermissions("coupon:smsseckillskunotice:update")
    public Result update(@RequestBody SmsSeckillSkuNoticeDTO dto){
        //效验数据
        ValidatorUtils.validateEntity(dto, UpdateGroup.class, DefaultGroup.class);

        smsSeckillSkuNoticeService.update(dto);
...
//    @RequiresPermissions("coupon:smsseckillskunotice:delete")
    public Result delete(@RequestBody Long[] ids){
        ...
        smsSeckillSkuNoticeService.delete(ids);
    ...
    @LogOperation("导出")
//   @RequiresPermissions("coupon:smsseckillskunotice:export")
    public void export(@Parameter(hidden = true) @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<SmsSeckillSkuNoticeDTO> list = smsSeckillSkuNoticeService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "秒杀商品通知订阅", list, SmsSeckillSkuNoticeExcel.class);
    }
