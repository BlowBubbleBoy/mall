...
import com.bubbleboy.modules.member.excel.UmsMemberCollectSubjectExcel;
...
//    @RequiresPermissions("member:umsmembercollectsubject:page")
    public Result<PageData<UmsMemberCollectSubjectDTO>> page(@Parameter(hidden = true) @RequestParam Map<String, Object> params){
        PageData<UmsMemberCollectSubjectDTO> page = umsMemberCollectSubjectService.page(params);

        return new Result<PageData<UmsMemberCollectSubjectDTO>>().ok(page);
    }

    @GetMapping("{id}")
    @Operation(summary = "信息")
//    @RequiresPermissions("member:umsmembercollectsubject:info")
    public Result<UmsMemberCollectSubjectDTO> get(@PathVariable("id") Long id){
        UmsMemberCollectSubjectDTO data = umsMemberCollectSubjectService.get(id);

        return new Result<UmsMemberCollectSubjectDTO>().ok(data);
    }
...
//    @RequiresPermissions("member:umsmembercollectsubject:save")
    public Result save(@RequestBody UmsMemberCollectSubjectDTO dto){
        //效验数据
        ValidatorUtils.validateEntity(dto, AddGroup.class, DefaultGroup.class);

        umsMemberCollectSubjectService.save(dto);
...
//    @RequiresPermissions("member:umsmembercollectsubject:update")
    public Result update(@RequestBody UmsMemberCollectSubjectDTO dto){
        //效验数据
        ValidatorUtils.validateEntity(dto, UpdateGroup.class, DefaultGroup.class);

        umsMemberCollectSubjectService.update(dto);
...
//    @RequiresPermissions("member:umsmembercollectsubject:delete")
    public Result delete(@RequestBody Long[] ids){
        ...
        umsMemberCollectSubjectService.delete(ids);
    ...
    @LogOperation("导出")
//   @RequiresPermissions("member:umsmembercollectsubject:export")
    public void export(@Parameter(hidden = true) @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<UmsMemberCollectSubjectDTO> list = umsMemberCollectSubjectService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "会员收藏的专题活动", list, UmsMemberCollectSubjectExcel.class);
    }
