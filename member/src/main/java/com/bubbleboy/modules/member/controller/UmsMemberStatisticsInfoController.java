...
import com.bubbleboy.modules.member.excel.UmsMemberStatisticsInfoExcel;
...
//    @RequiresPermissions("member:umsmemberstatisticsinfo:page")
...
//    @RequiresPermissions("member:umsmemberstatisticsinfo:delete")
    ...
    @LogOperation("导出")
//   @RequiresPermissions("member:umsmemberstatisticsinfo:export")
    public void export(@Parameter(hidden = true) @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<UmsMemberStatisticsInfoDTO> list = umsMemberStatisticsInfoService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "会员统计信息", list, UmsMemberStatisticsInfoExcel.class);
    }
