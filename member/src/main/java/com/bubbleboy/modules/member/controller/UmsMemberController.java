...
import com.bubbleboy.modules.member.excel.UmsMemberExcel;
...
//    @RequiresPermissions("member:umsmember:page")
...
//    @RequiresPermissions("member:umsmember:delete")
    ...
    @LogOperation("导出")
//   @RequiresPermissions("member:umsmember:export")
    public void export(@Parameter(hidden = true) @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<UmsMemberDTO> list = umsMemberService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "会员", list, UmsMemberExcel.class);
    }
