...
import com.bubbleboy.modules.member.excel.UmsMemberLevelExcel;
...
//    @RequiresPermissions("member:umsmemberlevel:page")
    public Result<PageData<UmsMemberLevelDTO>> page(@Parameter(hidden = true) @RequestParam Map<String, Object> params){
        PageData<UmsMemberLevelDTO> page = umsMemberLevelService.page(params);

        return new Result<PageData<UmsMemberLevelDTO>>().ok(page);
    }

    @GetMapping("{id}")
    @Operation(summary = "信息")
//    @RequiresPermissions("member:umsmemberlevel:info")
    public Result<UmsMemberLevelDTO> get(@PathVariable("id") Long id){
        UmsMemberLevelDTO data = umsMemberLevelService.get(id);

        return new Result<UmsMemberLevelDTO>().ok(data);
    }
...
//    @RequiresPermissions("member:umsmemberlevel:save")
    public Result save(@RequestBody UmsMemberLevelDTO dto){
        //效验数据
        ValidatorUtils.validateEntity(dto, AddGroup.class, DefaultGroup.class);

        umsMemberLevelService.save(dto);
...
//    @RequiresPermissions("member:umsmemberlevel:update")
    public Result update(@RequestBody UmsMemberLevelDTO dto){
        //效验数据
        ValidatorUtils.validateEntity(dto, UpdateGroup.class, DefaultGroup.class);

        umsMemberLevelService.update(dto);
...
//    @RequiresPermissions("member:umsmemberlevel:delete")
    public Result delete(@RequestBody Long[] ids){
        ...
        umsMemberLevelService.delete(ids);
    ...
    @LogOperation("导出")
//   @RequiresPermissions("member:umsmemberlevel:export")
    public void export(@Parameter(hidden = true) @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<UmsMemberLevelDTO> list = umsMemberLevelService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "会员等级", list, UmsMemberLevelExcel.class);
    }
