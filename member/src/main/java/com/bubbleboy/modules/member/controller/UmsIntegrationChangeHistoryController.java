...
import com.bubbleboy.modules.member.excel.UmsIntegrationChangeHistoryExcel;
...
//    @RequiresPermissions("member:umsintegrationchangehistory:page")
...
//    @RequiresPermissions("member:umsintegrationchangehistory:delete")
    ...
    @LogOperation("导出")
//   @RequiresPermissions("member:umsintegrationchangehistory:export")
    public void export(@Parameter(hidden = true) @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<UmsIntegrationChangeHistoryDTO> list = umsIntegrationChangeHistoryService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "积分变化历史记录", list, UmsIntegrationChangeHistoryExcel.class);
    }
